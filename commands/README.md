...
All six commands contain the same logic — only the wrapper format differs. Copy the file(s) into your project and commit them so your whole team gets the command.
